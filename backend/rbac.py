...
PERMISSIONS = {
    ...
    models.UserRole.REGISTRAR: {
        ...
        "operations:view", "operations:create", "operations:edit", "files:view", "files:create",
        "report_cards:print",
    },
    models.UserRole.RECEPTIONIST: {"students:view", "parents:view", "messages:create", "notifications:view"},
    models.UserRole.SECRETARY: {"students:view", "teachers:view", "files:view", "files:create", "report_cards:print", "messages:create"},
    ...
    models.UserRole.ACCOUNTANT: {"finance_fees:view", "invoices:view", "payments:view", "receipts:view", "expenses:view", "accounting:view", "accounting:export"},
    models.UserRole.TEACHER: {
        "students:view", "classes:view", "subjects:view", "timetable:view", "grades:view",
        "grades:create", "grades:edit", "report_cards:view", "files:view", "files:create",
    },
    models.UserRole.EDUCATOR: {"students:view", "students:edit", "classes:view", "messages:create", "notifications:create"},
    models.UserRole.TRAINER: {"students:view", "classes:view", "subjects:view", "grades:view", "grades:create", "files:create"},
    models.UserRole.INSTRUCTOR: {"students:view", "classes:view", "subjects:view", "grades:view", "grades:create", "files:create"},
    models.UserRole.PARENT: {"portal:view", "portal:create", "files:view", "files:create", "payments:view"},
    models.UserRole.STUDENT: {"portal:view", "portal:create", "files:view", "files:create", "grades:view", "timetable:view"},
    models.UserRole.PUPIL: {"portal:view", "files:view", "grades:view", "timetable:view"},
