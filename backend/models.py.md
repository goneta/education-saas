...
- Defines the SQLAlchemy data model, including AI provider configuration, AI wallets with daily/monthly limits, credit transactions, AI usage logs, platform payments, and school payment accounts.
