...
const HELP_SECTIONS: HelpSection[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            { fr: "Suivi des absences : lancez après les cours — chaque absence non encore suivie déclenche le message au parent (notification dans sa langue + SMS si téléphone enregistré), une seule fois par absence.", en: "Absence follow-up: run after class — every absence not yet followed up triggers the parent message (notification in their language + SMS when a phone is on file), exactly once per absence.", es: "Seguimiento de ausencias: ejecute tras las clases — cada ausencia aún no seguida dispara el mensaje al padre (notificación en su idioma + SMS si hay teléfono), una sola vez por ausencia.", sw: "Ufuatiliaji wa kutokuwepo: endesha baada ya vipindi — kila kutokuwepo ambako hakujafuatiliwa huchochea ujumbe kwa mzazi (arifa kwa lugha yake + SMS ikiwa simu imehifadhiwa), mara moja tu kwa kila kutokuwepo.", },
