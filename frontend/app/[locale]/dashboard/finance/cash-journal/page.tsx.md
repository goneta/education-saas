...
- `frontend/app/[locale]/dashboard/finance/cash-journal/page.tsx`
...
- Breakdown tables (by fee type / by operator) are laid out one per row (full width), not two-up, for readability across breakpoints.
