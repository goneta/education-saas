# assignments/page.tsx — Teacher homework page

Teacher UI over /assignments: create (manual fields + "Generate with AI" that
fills content+answer_key), save-draft/publish, a list of owned assignments with
