...
- Nouvelles pages: "school-life" (5 modules Vie scolaire: objectif, écrans, modèles, permissions — Santé en lecture restreinte —, référentiels, workflows, API) et "reference-data" (données globales 🌐 vs locales 🏫, tableau des permissions, mécanisme des formulaires intelligents, API, règles pour les développements futurs). Groupes: onglet Features → "School life"; onglet Admin → entrée "Reference lists & smart forms".
