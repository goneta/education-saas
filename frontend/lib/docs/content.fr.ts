    ...
    "billing": {
        ...
        blocks: P(
            ...
            { k: "table", headers: ["Onglet", "Rôle"], rows: [
                ...
                ["Historique / Transactions", "Factures et transactions projetées depuis les paiements de la plateforme, avec badges de statut, filtres, export CSV, téléchargement de la facture en PDF en un clic (un vrai PDF généré par reportlab avec émetteur, destinataire, détail de la taxe, totaux et une référence QR vérifiable) et envoi de la facture PDF par e-mail aux destinataires de facturation (SMTP)."],
                ["Crédits / Consommation", "Solde de crédits et consommation avec graphiques en direct : une tendance par jour (crédits, jetons IA, requêtes ou dépenses) sur 7/30/90 jours et une répartition des crédits par module ; la boutique de crédits ouvre la page des crédits IA."],
            ...
            { k: "callout", tone: "note", title: "Socle + feuille de route", text: "Livré : la page et l'API unifiées (aperçu, changement d'abonnement, préférences, fiscalité, configuration de recharge automatique, vérification/application de promo, factures/transactions projetées, consommation, audit, revenu super-admin) ainsi que le téléchargement de la facture en PDF en un clic, l'envoi de la facture PDF par e-mail (SMTP), la gestion complète des moyens de paiement enregistrés, un assistant de facturation IA ancré dans vos données réelles et des graphiques de consommation en direct. Les quatre éléments de la feuille de route sont désormais livrés." },
        ),
    },
