...
export const DOC_PAGES_FR: Record<string, DocPage> = {
    ...
    "billing": {
        ...
        blocks: P(
            ...
            { k: "callout", tone: "note", title: "Socle + feuille de route", text: "Livré : la page et l'API unifiées (aperçu, changement d'abonnement, préférences, fiscalité, configuration de recharge automatique, vérification/application de promo, factures/transactions projetées, consommation, audit, revenu super-admin) ainsi que le téléchargement de la facture en PDF en un clic, la gestion complète des moyens de paiement enregistrés, un assistant de facturation IA ancré dans vos données réelles et des graphiques de consommation en direct. Feuille de route : envoi des factures par e-mail — les données sous-jacentes existent déjà dans TeducAI." },
        ),
    },
